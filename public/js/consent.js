...
(function () {
  ...
  function injectStyles() {
    ...
    var css = [
      ...
      '.osi-cc-banner{position:fixed;left:0;right:0;bottom:0;z-index:9000;background:rgba(9,13,18,0.97);border-top:1px solid rgba(79,140,196,0.35);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);box-shadow:0 -8px 32px rgba(0,0,0,0.4);transform:translateY(110%);transition:transform .35s ease}',
      ...
      '.osi-cc-title{font-family:'Archivo Expanded','Archivo',sans-serif;font-weight:700;font-size:1rem;letter-spacing:.04em;text-transform:uppercase;color:#fff;margin:0 0 .35rem}',
      '.osi-cc-text p{margin:0;font-size:.82rem;line-height:1.55;color:#b9c7d4}',
      '.osi-cc-text a{color:#4F8CC4;text-decoration:underline}',
      '.osi-cc-actions{display:flex;gap:.6rem;flex-wrap:wrap;align-items:center}',
      '.osi-cc-btn{font-family:'IBM Plex Sans',sans-serif;font-weight:600;font-size:.78rem;letter-spacing:.04em;text-transform:uppercase;padding:.6rem 1.2rem;border-radius:4px;border:1px solid transparent;cursor:pointer;transition:all .18s ease;white-space:nowrap}',
      '.osi-cc-btn-accept{background:#E8A317;color:#0F1722;border-color:#E8A317}',
      '.osi-cc-btn-accept:hover{background:#CE8E0C;border-color:#CE8E0C}',
      ...
      '.osi-cc-btn-custom:hover{color:#4F8CC4}',
      ...
      '.osi-cc-modal{width:100%;max-width:560px;max-height:90vh;overflow:auto;background:#0d1620;border:1px solid rgba(79,140,196,0.28);border-radius:8px;padding:1.6rem}',
      '.osi-cc-modal h2{font-family:'Archivo Expanded','Archivo',sans-serif;font-weight:700;font-size:1.25rem;letter-spacing:.03em;text-transform:uppercase;color:#fff;margin:0 0 .5rem}',
      '.osi-cc-modal>p{font-size:.84rem;line-height:1.6;color:#b9c7d4;margin:0 0 1.25rem}',
      '.osi-cc-cat{border:1px solid rgba(79,140,196,0.16);border-radius:6px;padding:1rem 1.1rem;margin-bottom:.8rem;background:rgba(255,255,255,0.02)}',
      '.osi-cc-cat-head{display:flex;align-items:center;justify-content:space-between;gap:1rem;margin-bottom:.4rem}',
      '.osi-cc-cat-name{font-family:'Archivo Expanded','Archivo',sans-serif;font-weight:700;font-size:.95rem;letter-spacing:.03em;text-transform:uppercase;color:#eaf2f8}',
      '.osi-cc-cat p{margin:0;font-size:.78rem;line-height:1.5;color:#9fb2c2}',
      '.osi-cc-pill{font-size:.68rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#4F8CC4}',
      ...
      '.osi-cc-switch input:checked+.osi-cc-slider{background:#4F8CC4}',
